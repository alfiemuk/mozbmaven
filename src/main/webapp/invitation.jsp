...
<body class=" ">
    <%@include file="headerin.jsp" %>   
       <div class="container p-5  bg-light">
          <%
             ...
             String elinya=request.getParameter("erinya").toUpperCase();
             String dclass="";     
  ...
  //String appPath = System.getProperty("user.home")+File.separator+"cards";
    //String appPath=request.getServletContext().getContextPath()+File.separator+"cards" ;
        //    String appPath = request.getServletContext().getRealPath("");
            String bulkfile = appPath+File.separator+"NBCARDS"   ;
...
File FILE = new File(bulkfile+File.separator+ fName);
      ...
      Font classFont= new Font(Font.FontFamily.TIMES_ROMAN, 20,Font.NORMAL, new BaseColor(0, 17, 17));
        ...
        Font personFont= new Font(Font.FontFamily.HELVETICA, 14,Font.BOLD, new BaseColor(179, 0, 0));
        Font personFont2= new Font(Font.FontFamily.TIMES_ROMAN, 18,Font.BOLD, new BaseColor(210, 45, 45));
                  ...
                  try
{
         ...
         Image image1 = Image.getInstance(appPath+"images"+File.separator+"card.png");
               image1.setAbsolutePosition(0f, 0f);
               image1.scaleToFit(842,595);
...
} catch (Exception e)
{
 ...
 table.setSpacingAfter(55f); //Space after table
 //Set Column widths
 float[] columnWidths = {1f};
 table.setWidths(columnWidths);
 PdfPCell cell1 = new PdfPCell(new Paragraph("",personFont));
  cell1.setPadding(5);
   cell1.setBorderWidth(0);
   cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
 cell1.setVerticalAlignment(Element.ALIGN_MIDDLE);
 ...
 PdfPTable table = new PdfPTable(1); // 3 columns.
 table.setWidthPercentage(100); //Width 100%
 table.setSpacingBefore(124f); //Space before table
 table.setSpacingAfter(0f); //Space after table
 //Set Column widths
 float[] columnWidths = {1f};
 table.setWidths(columnWidths);
 PdfPCell cell1 = new PdfPCell(new Paragraph(person,personFont2));
  cell1.setPadding(5);
...
document.close();
  ...
  <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
        ...
        <%                 
                        response.sendRedirect("./NBCARDS/"+fName); 
        } catch (Exception e) {
